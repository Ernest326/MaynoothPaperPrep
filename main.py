...
user = tk.Entry(user_frame, ).grid(row=0, column=1, padx=5, pady=5, sticky="w")

tk.Label(user_frame, text="Password").grid(row=1, column=0, padx=5, pady=5, sticky="w")
password = tk.Entry(user_frame, show="*").grid(row=1, column=1, padx=5, pady=5, sticky="w")
...
module = tk.Entry(paper_frame).grid(row=0, column=1, padx=5, pady=5, sticky="w")
...
start_button = tk.Button(root, text="Start", bg="lightblue", command=lambda: print("Start button clicked"))
